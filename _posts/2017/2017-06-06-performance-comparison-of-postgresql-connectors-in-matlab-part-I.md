...
-->
![Inserting of scalar numericals](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/compareInsertForNumScalars_traj_full.jpeg)

<!---
![Inserting of scalar numericals](compareInsertForNumScalars_traj_cropped.jpeg =700x373)
-->
![Inserting of scalar numericals](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/compareInsertForNumScalars_traj_cropped.jpeg)
...
-->
![Inserting of scalar numericals](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/compareInsertForNumScalars_bar_full.jpeg)
...
-->
![Inserting of scalar numericals](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/compareInsertForNumScalars_traj_wofi.jpeg)
![Inserting of scalar numericals](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/compareInsertForNumScalars_bar_wofi.jpeg)
...
-->
![Inserting of scalar data with timestamps](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/compareInsertForScalarsInCell_traj.jpeg)
![Inserting of scalar data with timestamps](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/compareInsertForScalarsInCell_bar.jpeg)
...
-->
![Inserting of arrays](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/compareInsertForArrays_traj_full.jpeg)
![Inserting of arrays](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/compareInsertForArrays_traj_cropped.jpeg)
![Inserting of arrays](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/compareInsertForArrays_bar_full.jpeg)
...
-->
![Inserting of arrays](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/compareInsertForArrays_traj_self.jpeg)
![Inserting of arrays](/img/posts{{ page.path | remove: '_posts' | remove: '.md' }}/compareInsertForArrays_bar_self.jpeg)
